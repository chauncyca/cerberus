...
setup(
    name='cerberus',
    version='1',
    packages=['venv.Lib.site-packages.cv2', 'venv.Lib.site-packages.cv2.data', 'venv.Lib.site-packages.pip',
              ...
              'venv.Lib.site-packages.pip-10.0.1-py3.6.egg.pip._internal.operations', 'cerberus'],
    url='https://github.com/chauncyca/cerberus.git',
    license='MIT',
    author='Charles Chauncy',
    author_email='contactcharleschauncy@gmail.com',
    description='Door Guarding Service'
)
